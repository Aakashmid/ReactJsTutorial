...
export default function Card({ product }) {
    ...
    return (
        <>
            <div className={`${loading ? 'hidden' : ''} product-card flex flex-col bg-white rounded-lg  px-4 py-2 `} style={{ boxShadow: ' 0px 0px 4px 1px rgba(97,97,97,1)' }}>
                ...
                <div className=" gap-2 lg:gap-4 grid grid-cols-2 action buttons mt-auto">
                    ...
                    <button className=" px-2 py-1 bg-blue-500 rounded-lg lg:text-lg  text-white cursor-pointer">Add to cart
                    </button>
                </div>
            </div>
            {loading &&
